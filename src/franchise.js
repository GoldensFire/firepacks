...
// ответы-механики), сюда не переносится: до этого уровня у SIFirePacks просто нет
 ...
 * в src/gemini.js), но модель нет-нет да и ответит по-английски, и тогда
