...
export const STEPS = [
	...
	// пакам отпечатки считает сам разбор (см. fetchPrints в src/indexer/backfill.js)
	{ key: 'prints', name: 'Отпечатки вопросов', flag: '--prints', byDefault: true, feeds: ['parse'] },
	...
	// range-запрос ВК не тянет (см. fetchDurations в src/indexer/backfill.js). На библиотеке это часы,
