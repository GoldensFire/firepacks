 ...
 * в gemini.js), иначе крупные пачки упирались бы в него раньше суточного.
 *
 ...
 */
export function nextSpareModel(current = currentModel()) {
	const candidates = MODELS
		.filter(model => model.spare && model.id !== current)
