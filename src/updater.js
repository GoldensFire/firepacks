...
export const UPDATE_STEPS = [
	...
	},
	{
		...
		hint: 'Без сети: ищет паки, чьи темы почти целиком уже стояли в чужих паках, выложенных раньше. '
			+ 'Пересматривает всю базу каждый раз, а не одну очередь, — иначе найденный сегодня '
			+ 'старый пак так и остался бы числиться первоисточником. Считаные секунды.',
	},
	{
		key: 'recalc',
