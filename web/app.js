...
async function start() {
	...
	// Ссылка на страницу обновления — только тому, кому обновлять можно: на хостинге
	// собирать базу нечем вовсе, а дома — только хозяину сайта, если список хозяев
	// заведён (см. canUpdate в src/server.js). Прячется она здесь одна лишь с глаз:
	// сама страница и все методы /api/update/* закрыты на сервере, и нарисовать
	// ссылку себе руками ничего не даёт.
	//
