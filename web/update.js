...
//
// Рядом с ним отмечены и отпечатки вопросов: по ним плагиат и ищется, и без них
// шаг слеп ко всей старой библиотеке. Сети они касаются, но ровно один раз —
// пока база не размечена; дальше очередь у них пуста (см. fetchPrints)
const DEFAULT_STEPS = new Set(['vk', 'parse', 'stats', 'topics', 'summary', 'prints', 'plagiarism']);
